...
import cn.xgs.domain.vo.MetaVO;
import cn.xgs.domain.vo.RouterVO;
import cn.xgs.mapper.system.SysMenuMapper;
import cn.xgs.mapper.system.SysRoleMapper;
import cn.xgs.mapper.system.SysRoleMenuMapper;
import cn.xgs.service.ISysMenuService;
...
public class SysMenuServiceImpl implements ISysMenuService {
     ...
     */
    @Override
    public List<Long> selectMenuListByRoleId(Long roleId, String type) {
        SysRole role = roleMapper.selectRoleById(roleId);
        return menuMapper.selectMenuListByRoleId(roleId, role.isMenuCheckStrictly(), type);
    }
    ...
    public String innerLinkReplaceEach(String path) {
        return StringUtil.replaceEach(path, new String[]{Constants.HTTP, Constants.HTTPS, Constants.WWW, "."},
                new String[]{"", "", "", "/"});
    }
}
